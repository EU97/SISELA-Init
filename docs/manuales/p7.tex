...
\subsection{Caso 3: posicionamiento ARINC 429 por terminal serial}
El firmware recibe una trama hexadecimal (simulando Label 204), valida la paridad impar,
extrae el ángulo BNR (bits 11--28), calcula la trayectoria mínima ($\Delta$ pasos con
signo, plegando sobre $\pm\text{SPR}/2$) y mueve el motor en la dirección correspondiente.
...
STEP/DIR del A4988 según la macro \code{STEPPER\_ULN2003}. Compilar con
\code{pio run -e esp32dev} o \code{pio run -e pico} (con \code{-DPRACTICE=7}).
