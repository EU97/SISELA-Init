...
# --- Configuración global (RP2040) ---
DRIVER_TYPE = "A4988"  # Cambiar a "ULN2003" para usar 28BYJ-48

# Pines para A4988/DRV8825 (RP2040)
A4988_STEP_PIN = 18  # GP18
A4988_DIR_PIN = 19   # GP19
A4988_EN_PIN = 5     # GP5 (opcional)

# Pines para ULN2003 (28BYJ-48) (RP2040)
ULN2003_PINS = [26, 27, 28, 22]  # 🔄 GP26, GP27, GP28, GP22 (IN1-IN4)

# Fin de carrera opcional
ENDSTOP_PIN = 4  # GP4, pull-up interno, contacto a GND
...
def mode_homing(driver, endstop):
    ...
    if endstop is None:
        print("[WARN] Fin de carrera no configurado en GP{}. Abortando.".format(ENDSTOP_PIN))
        time.sleep(2)
        return
...
def mode_info(_driver, driver_type: str):
    ...
    print("\n[Modo 5] Info del driver (RP2040)")
    print("Tipo: {}".format(driver_type))
    if driver_type == "A4988":
        print("  STEP: GP{}".format(A4988_STEP_PIN))
        print("  DIR: GP{}".format(A4988_DIR_PIN))
        print("  ENABLE: GP{}".format(A4988_EN_PIN if A4988_EN_PIN else "N/A"))
    ...
    print("  Fin de carrera: GP{} {}".format(
        ENDSTOP_PIN,
...
def main():
    ...
    if endstop:
        print("[INFO] Fin de carrera configurado en GP{}.".format(ENDSTOP_PIN))
    else:
